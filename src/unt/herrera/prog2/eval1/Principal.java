...
//        
        ...
        Trabajo trab1= nuevoTrabajo1("Protocolos de comunicación", listaA1,6, fecha1,fechaVacia, listaAeT, listaRT);
        if(trab1!= null){
        ...
        Trabajo trab2= nuevoTrabajo1("Gestión de Trabajos Finales", listaA2,8, fecha1,fechaVacia, listaAeT2, listaRT2);
        if(trab2!= null){
       ...
       //TRABAJO 3 
        ...
        Trabajo trab3= nuevoTrabajo1("Este es el titulo del Trabajo", listaA3,4, fecha4,fechaVacia, listaAeT3, listaRT3);;
        if(trab2!= null){
...
//        
        ...
        //Trabajo trab4 = new Trabajo ("Este es el titulo del Trabajo", listaA1,5, fecha5, listaAeT4, listaRT4);
         Trabajo trab4= nuevoTrabajo1("Este es el titulo del Trabajo", listaA1,5, fecha5,fechaVacia, listaAeT4, listaRT4);;
        if(trab2!= null){
       ...
       //</editor-fold> 
        ...
        //Trabajo trab2 = new Trabajo ("Gestión de Trabajos Finales", listaA2,8, fecha1, listaAeT2, listaRT2);
        Trabajo t5= nuevoTrabajo1("Gestión de Trabajos Finales", listaA2,8, fecha1, fechaAp, listaAl5, listaR5);
        if (t5!=null){
        ...
        //Trabajo trab2 = new Trabajo ("Gestión de Trabajos Finales", listaA2,8, fecha1, listaAeT2, listaRT2);
        Trabajo t6= nuevoTrabajo1("", listaA2,5, fecha1, fechaAp6, listaAl6, listaR6);
        if (t6!=null){
        ...
        Trabajo t7= nuevoTrabajo1("Segurida en Redes", listaA4,-5, fecha3, fechaAp6, listaAl7, listaR7);
        if (t7!=null){
        ...
        Trabajo t8= nuevoTrabajo1("Seguridad en Redes", listaA3,7, fecha3, fecha1, listaAl8, listaR8);
        if (t8!=null){
        ...
        Trabajo t9= nuevoTrabajo1("Sistema de Gestión", listaA1,7, fecha4, fecha1, listaAl9, listaR9);
        if (t9!=null){
    ...
    //</editor-fold> 
        ...
        Trabajo t10= nuevoTrabajo1("Sistema de Gestión 2", listaA1,4, fecha4, fecha1, listaAl10, listaR10);
        if (t10!=null){
    ...
    //</editor-fold> 
        ...
        Trabajo t11= nuevoTrabajo1("Sistema de Gestión 2", listaA1,4, fecha4, fecha1, listaAl11, listaR11);
        if (t11!=null){
    ...
    //</editor-fold> 
        ...
        Trabajo t12= nuevoTrabajo1("Sistema de Gestión Nuevo", listaA1,4, fecha4, fecha1, listaAl12, listaR12);
        if (t12!=null){
    ...
    //</editor-fold> 
        ...
        //FALTA AGREGAR JURADO, SEMINARIO
//        //System.out.println(listaTrabajos.size());
//        System.out.println("\n*** Trabajo 3 *** \n ");
//        trab3.mostrar();
//        System.out.println("\n*** Agregar Jurado al Trabajo 3*** \n ");
...
//        System.out.println(trab3.agregarProfesor(rt42));//No debería poder agregarlo.
//        System.out.println(trab3.agregarProfesor(rt44)); 
//        trab3.setFechaAprobacion(fecha4);
//        
//        System.out.println("\n*** TRABAJO 3 CON JURADO *** \n ");
//        listaTrabajos.get(2).mostrar();  
//        
//        System.out.println("\n*** Agregar Jurado al Trabajo 1 *** \n ");
//        //AGREGAR JURADO, FECHA APROBACION
...
//        
//        System.out.println("\n*** TRABAJO 1 CON JURADO *** \n ");
//        listaTrabajos.get(0).mostrar();  
//   
//        //***********************AGREGAR SEMINARIO A UN TRABAJO******************************
//        Seminario s1 = new Seminario(fecha6, NotaAprobacion.APROBADO_SINOBS, null);
//        Seminario s2 = new Seminario(fecha6, NotaAprobacion.APROBADO_SINOBS, null);
//        Seminario s3 = new Seminario(fecha4, NotaAprobacion.APROBADO_CONOBS, null);
//        listaTrabajos.get(2).agregarSeminario(s1);
//        listaTrabajos.get(2).agregarSeminario(s2);
//        listaTrabajos.get(2).agregarSeminario(s3);//fecha anterior a un sem existente VER
//        
//        System.out.println("\n*** Trabajo 3 *** \n ");
//        listaTrabajos.get(2).mostrarDetallado();
    } 
    public static Trabajo nuevoTrabajo1(String titulo, ArrayList<Area> area,int duracion,
        ...
        String mensaje="";
        int b=0,b1=0,b2=0;
        boolean a=false, tu=false, j=false;
            ...
            if(!area.isEmpty()){
                if(duracion >0 ){
                    if(fechaPresentacion !=null)
                        ...
                        mensaje += "Fecha de Presentación inválida. ";
                }
                else
                    mensaje += "Duración inválida. ";
            }
            else
                mensaje += "No hay lista de Areas. ";
        }
        else
            mensaje += "Título no es válido";
        ...
        if(b==1){
            if (fechaAprobacion ==null)
                ...
                if(fechaAprobacion.isAfter(fechaPresentacion)){
                    b2=1;
                }
                else
                    mensaje += "La fecha de Aprobación debe ser posterior a la presentacion";
        }
        
        
        //controlo los alumnos
        //no vacía, 1 o 2 alumnos, dos alumnos diferentes
        //no alumnos en otro trabajo --> dejar para tp5
        a= controlarAlumnos(listaAlumnoEnT);
        if(!a)
           mensaje += "Verificar los alumnos. "; 
        //controlo los profesores TUTORES 
        //con TUTORES. T=1, CT =0 o 1,Ex =0 o 1,  T!=CT  T!= E  CT!= E
        tu= controlarTutores(listaRolEnT);
        if(!tu)
           mensaje += "Verificar los tutores. "; 
        //controlo los profesores JURADbOS
        //al menos 3, 3J!=, != T Y CT
        j= controlarJurados(listaRolEnT);
        if(!j)
           mensaje += "Verificar los jurados. ";
        if(b1==1){
            if(b==1 && a && tu && j){
                t=new Trabajo(titulo, area, duracion,fechaPresentacion, listaAlumnoEnT , listaRolEnT);
        ...
        {
            if(b==1&& b2==1 && a && tu && j){
                t=new Trabajo(titulo, area, duracion,fechaPresentacion, fechaAprobacion, listaAlumnoEnT , listaRolEnT);
...
return t;
    ...
    public static boolean controlarAlumnos (ArrayList<AlumnoEnTrabajo> listaA){
        //controlo los alumnos
        //no vacía, 1 o 2 alumnos, dos alumnos diferentes
        //no alumnos en otro trabajo --> dejar para tp5
    ...
    public static boolean controlarJurados (ArrayList<RolEnTrabajo> listaR){
        ...
        //que la lista tenga datos
        if(listaR.isEmpty()|| listaR == null) // la lista no es vacia
            return false;
        else
        {
            for(RolEnTrabajo rt : listaR){
