...
public class Principal {
    public static void main (String Args[] ) { 
        ...
        //ALUMNO
        Persona al1= new Alumno("Musa", "Ezequiel", 6, "16345");
        Persona al2= new Alumno("Martinez", "Ricardo Juan", 7, "16343");
        Persona al3= new Alumno("Gimenez", "María José", 8, "16344");
        Persona al4= new Alumno("Flores", "Mauricio José", 6, "16543");
        Persona al5= new Alumno("Campos", "Juan Pablo", 9, "17345");
        Persona al6= new Alumno("Campos", "Augusto", 4, "17348");
        Persona al7= new Alumno("Rodriguez", "Miguel Angel", 10, "17346");
        Persona al8= new Alumno("Alvarez", "Ezequiel", 11, "16345");
        Persona al9= new Alumno("Aguero", "Luciana", 12, "17349");
        Persona al10= new Alumno("Campos Figueroa", "Juana", 13, "16345");
        Persona al11= new Alumno("Apud", "Josefina", 14, "18345");
