...
//    }
    ...
    public Trabajo(String titulo, List<Area> area,int duracion,  LocalDate fechaPresentacion, List<AlumnoEnTrabajo> listaAlumnoEnT, List<RolEnTrabajo> listaRolEnT) {
        this.titulo=titulo;
